// Extends the bas functionality of JavaScript
...
// Reset game variables and layouts bt does not start the game (game starts on keypress)
function resetGame() {
  // Reset game progress
  phase = 'waiting';
...
function animate(timestamp) {
  ...
  switch (phase) {
    ...
    case 'walking':
      ...
      if (nextPlatform) {
        // If her will reach another platform then limit it's position at it's edge
        const maxHeroX = nextPlatform.x + nextPlatform.y - heroDistanceFromEdge;
        if (heroX > maxHeroX) {
          heroX = maxHeroX;
          phase = 'transitioning';
        }
