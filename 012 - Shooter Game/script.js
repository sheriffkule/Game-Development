...
function animate(timestamp) {
  ...
  drawScore();
  [...particleArray, ...ravens, ...explosions].forEach((object) => object.update(deltaTime));
  [...particleArray, ...ravens, ...explosions].forEach((object) => object.draw());
  ravens = ravens.filter((object) => !object.markedForDeletion);
  explosions = explosions.filter((object) => !object.markedForDeletion);
  particleArray = particleArray.filter((object) => !object.markedForDeletion);
