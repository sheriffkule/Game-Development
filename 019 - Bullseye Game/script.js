window.addEventListener('load', function () {
  ...
  class Player {
    ...
    update() {
      ...
      if (this.distance > this.speedModifier) {
        this.speedX = this.dx / this.distance || 0;
        this.speedY = this.dy / this.distance || 0;
      } else {
        this.speedX = 0;
        this.speedY = 0;
      }
  ...
  class Egg {
    constructor(game) {
      ...
      this.collisionY =
        this.game.topMargin + Math.random() * (this.game.height - this.game.topMargin - this.margin);
  ...
  class Game {
    ...
    render(context, deltaTime) {
      ...
      if (this.score >= this.winningScore) {
        ...
        context.fillText(message1, this.width * 0.5, this.height * 0.5 - 25);
    ...
    init() {
      ...
      while (this.obstacles.length < this.numberOfObstacles && attempts < 500) {
        ...
        this.obstacles.forEach((obstacle) => {
          ...
          const sumOfRadiants = testObstacle.collisionRadius + obstacle.collisionRadius + distanceBuffer;
          if (distance < sumOfRadiants) {
            overlap = true;
          }
        });
